...
for samples_count=1:nsamples
    ...
    tlay=SAMPLES(samples_count,12:19);
    orientlay=SAMPLES(samples_count,20:27);
    xcurrent=[E11 E22 v12 G12 XT XC YT YC SS tlay orientlay];
    
    
    %% WRITE THE NEW .BDF FILE!!!!
    FIL_PUCK_BULK2 = fopen('FAILURE_MAT_PROP_PUCK_BULK2.bdf','w');
    %                       $234567812345678$234567812345678$234567812345678$234567812345678$234567812345678
    fprintf(FIL_PUCK_BULK2,'MAT8   * 1              %16.7f%16.7f%16.12f +0001V9\n', E11,E22,v12);
    fprintf(FIL_PUCK_BULK2,'*+0001V9%16.7f%16.7f%16.7f                 +0001VA\n',G12,G23,G13);
    fprintf(FIL_PUCK_BULK2,'MATF   * 1               3                                               +0001VB\n');
    fprintf(FIL_PUCK_BULK2,'*+0001VB                                                                 +0001VC\n');
    fprintf(FIL_PUCK_BULK2,'*+0001VC CRI             8              %16.7f%16.7f +0001VD\n',XT,XC);
    fprintf(FIL_PUCK_BULK2,'*+0001VD%16.7f%16.7f                                 +0001VE\n',YT,YC);
    fprintf(FIL_PUCK_BULK2,'*+0001VE                                                                 +0001VF\n');
    fprintf(FIL_PUCK_BULK2,'*+0001VF%16.7f                                %16.12f +0001VG\n',SS,P12T);
    fprintf(FIL_PUCK_BULK2,'*+0001VG%16.12f%16.12f%16.12f                 +0001VH\n',P12T,P12C,P12C);
    fprintf(FIL_PUCK_BULK2,'*+0001VH                                                                 +0001VI\n');
    fprintf(FIL_PUCK_BULK2,'*+0001VI PF                                                              +0001VJ\n');
    fprintf(FIL_PUCK_BULK2,'*+0001VJ                                                                 +0001VK\n');
    fprintf(FIL_PUCK_BULK2,'++0001VK                                                                 +0001VL\n');
    ...
    pause(120);   %wait for six minutes to complete the simulation!!!
    
    %% EXTRACT THE DATA!!!
    postprocess_nastrandata()   %calls the post-processing data!!!
