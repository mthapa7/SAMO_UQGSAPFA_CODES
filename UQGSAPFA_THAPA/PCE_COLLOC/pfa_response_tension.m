...
function output=pfa_response_tension(SAMPLES)
global UQGSAPFA
...
for samples_count=1:nsamples
    ...
    pause(240);   %wait for six minutes to complete the simulation!!!
    
    %% EXTRACT THE DATA!!!
    postprocess_nastrandata_tension()   %calls the post-processing data!!!
